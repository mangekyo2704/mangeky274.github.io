...
namespace FruitShopSolution.Data.Migrations
{
    ...
    [Migration("20201211092125_addAdmin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FruitShopSolution.Data.Entities.Admin", b =>
                {
            ...
            modelBuilder.Entity("FruitShopSolution.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            Discount = 20,
                            OrderDate = new DateTime(2020, 12, 11, 16, 21, 24, 915, DateTimeKind.Local).AddTicks(8256),
            ...
            modelBuilder.Entity("FruitShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2020, 12, 11, 16, 21, 24, 914, DateTimeKind.Local).AddTicks(3957),
                            InputCount = 100000m,
                            Origin = "Mỹ",
                            OutputCount = 20000m,
                            Quantity = 100,
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2020, 12, 11, 16, 21, 24, 914, DateTimeKind.Local).AddTicks(7207),
                            InputCount = 100000m,
                            Origin = "Mỹ",
                            OutputCount = 20000m,
                            Quantity = 100,
            ...
            modelBuilder.Entity("FruitShopSolution.Data.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 11, 16, 21, 24, 906, DateTimeKind.Local).AddTicks(5716));
